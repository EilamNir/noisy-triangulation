import numpy as np
import src.simulation.generate_path
...
if __name__ == '__main__':
    ...
    ax1.plot3D(path1.position[1:1, 1], path1.position[1: 1, 2], path1.position[1: 1, 3], 'b.-')
    for i in np.arange(1,len(path1.position)+1):
        ax1.plot3D(path1.position[1:i, 1], path1.position [1: i, 2], path1.position[1: i, 3], 'b.-')
